...
If the Service Request number is given without any resolution details (e.g. *"I want to resolve SR-0011"*), the agent asks for the resolution details before proceeding.
